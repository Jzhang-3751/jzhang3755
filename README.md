...
<body>
  ...
  <div class="score">
    当前分数：<span id="score">0</span><br>
    历史最高分：<span id="highScore">0</span><br>
    <div id="endMessage"></div>
  </div>
  <div class="buttons">
    <button onclick="playerMove(-1)">← 左移</button>
    <button onclick="rotateLeft()">↺ 左旋转</button>
    <button onclick="rotateRight()">↻ 右旋转</button>
    <button onclick="playerMove(1)">→ 右移</button>
    <button onclick="playerDrop()">↓ 加速下落</button>
  </div>
